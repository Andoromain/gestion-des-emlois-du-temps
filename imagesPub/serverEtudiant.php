<?php
 ...
 include('server.php');
	...
	if(isset($_POST['register']))
	{
		...
		if(empty($prenomet))
		{
			array_push($errors,"Prenom is required");
		}
		if(empty($datenais))
		{
			array_push($errors,"Date de naissance is required");
		}
		if(empty($matriculeet))
		{
			array_push($errors,"Matricule is required");
		}
		if(empty($codep))
		{
			array_push($errors,"Parcours is required");
		}
		if(empty($codeniv))
		{
			array_push($errors,"Niveau is required");
		}
		if(empty($usernameet))
		{
