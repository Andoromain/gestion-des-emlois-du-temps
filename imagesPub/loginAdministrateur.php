                                                                    ...
                                                                    <div class="col">
                                                                        <div class="d-flex flex-column justify-content-center" id="login-box">
                                                                            ...
                                                                            <div class="email-login" style="background-color:#ffffff;">
                                                                                ...
                                                                                <div class="form-group"><label>password</label><input class="form-control form-control" type="password" name="mdpad" style="height: 20px;"></div>
                                                                            </div>
                                                                            ...
                                                                            <div id="login-box-footer" style="padding:10px 20px;padding-bottom:23px;padding-top:18px;">
                                                                                <p style="margin-bottom:0px;">Don't you have an account?<a id="register-link" href="inscriptionAdministrateur.php">Sign Up!</a></p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
