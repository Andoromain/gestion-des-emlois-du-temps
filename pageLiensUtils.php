            ...
            <div class="col-md-9 content">
                <div class="card" style="border: 0.5px solid #f5f5f5;">
                    <div class="card-header" style="border: 0.5px solid #f5f5f5;">
                        <div class="row">
                            <div class="col-12 col-sm-6 col-lg-7"><button class="btn btn-primary" type="button" style="font-family: 'Karla';font-size: 26px;padding: 0px 7px 0px 7px;top: -7px;font-weight: 800;border-radius: 0px;background-color: #EE161F;border-color: transparent;">Liens utiles</button></div>
                            <div
                ...
                <div class="card-body" style="border: 0.5px solid #f5f5f5;box-shadow: inset 0 0 10px;">
                    ...
                    <div class="jumbotron" style="padding: 15px;background-color: #fff;" >
                        <h1 class="text-center" style="font-family:'Aguafina Script', cursive;">Liens utiles &nbsp; </h1>
                        <p>Ministère de l'Enseignement Supérieur et de la Recherche Scientifique : <a style="text-decoration:underline" href="http://www.mesupres.gov.mg/">http://www.mesupres.gov.mg/</a></p>
						<p>Ministère de la Santé Publique : <a style="text-decoration:underline" href="http://www.sante.gov.mg/ministere-sante-publique/">http://www.sante.gov.mg/ministere-sante-publique/</a></p>
						<p>Université de Fianarantsoa : <a style="text-decoration:underline" href="https://www.univ-fianar.mg/">https://www.univ-fianar.mg/</a></p>
						<p>Faculté de Médecine d'Antananarivo  : <a style="text-decoration:underline" href="https://www.facmedtananarive.org/">https://www.facmedtananarive.org/</a></p>
						<p>La Revue Médicale de Madagascar  : <a style="text-decoration:underline" href="https://rmm.mg/">https://rmm.mg/</a></p>
						<p>Revue d'Anesthésie-Réanimation et de Médecine d'Urgence : <a style="text-decoration:underline" href="http://rarmu.org/">http://rarmu.org/</a></p>
						<p>Head and Neck Journal of Madagascar :<a style="text-decoration:underline" href="https://hnjm.mg/">https://hnjm.mg/</a></p>
						<p>Revue Malgache de Pédiatrie  : <a style="text-decoration:underline" href="http://www.societe-malgache-de-pediatrie.com/revue-malgache-de-pediatrie/">http://www.societe-malgache-de-pediatrie.com/revue-malgache-de-pediatrie/</a></p>
						<p>Programme Hinari d'accès à la recherche pour la santé : <a style="text-decoration:underline" href="https://www.who.int/hinari/fr/">https://www.who.int/hinari/fr/</a></p>
						<p>PubMed : <a style="text-decoration:underline" href="https://www.ncbi.nlm.nih.gov/pubmed/">https://www.ncbi.nlm.nih.gov/pubmed/</a></p>
