            ...
            <div class="col-md-9 content">
                <div class="card" style="border: 0.5px solid #f5f5f5;">
                    <div class="card-header" style="border: 0.5px solid #f5f5f5;">
                        <div class="row">
                            <div class="col-12 col-sm-6 col-lg-7"><button class="btn btn-primary" type="button" style="font-family: 'Karla';font-size: 26px;padding: 0px 7px 0px 7px;top: -7px;font-weight: 800;border-radius: 0px;background-color: #EE161F;border-color: transparent;">Actualités</button></div>
                            <div
                ...
                <div class="card-body" style="border: 0.5px solid #f5f5f5;box-shadow: inset 0 0 10px;">
                    ...
                    <div class="jumbotron" style="padding: 15px;background-color: #fff;" >
                       <!-- debut alaUne -->
                            ...
                            <h1 class="text-center" style="font-family:'Aguafina Script', cursive;"><?php echo $row["titre"]; ?></h1>
                            <p  style="text-align:justify"><?php echo $row["contenu"]; ?></p>
                            <div id="cbp-fwslider" class="cbp-fwslider">
                                <ul>
								<?php  if(!empty($row["image"])){
								echo '<li> <a href="imagesPub/'.$row["image"].'"><img  src="imagesPub/'.$row["image"].'"alt="img01"></a></li> ';
									}
									if(!empty($row["image1"])){
								echo '<li> <a href="imagesPub/'.$row["image1"].'"><img  src="imagesPub/'.$row["image1"].'"alt="img01"></a></li> ';
									}
									if(!empty($row["image2"])){
								echo '<li> <a href="imagesPub/'.$row["image2"].'"><img  src="imagesPub/'.$row["image2"].'"alt="img01"></a></li> ';
									}
									if(!empty($row["image3"])){
								echo '<li> <a href="imagesPub/'.$row["image3"].'"><img  src="imagesPub/'.$row["image3"].'"alt="img01"></a></li> ';
									}
							?>	
							</div>
							<br>
						...
						<!-- fin alaUne -->		
                                </ul><script src="assets/js/jquery.min.js"></script>
<script>
$( function() {
    /*
