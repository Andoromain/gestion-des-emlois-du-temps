...
<?php include('serverAdministrateur.php'); ?>
                                            ...
                                            <div class="col">
                                                <div>
													...
													<a href="index" style="font-size: 25px;"><i class="fa fa-home"></i></a>
                                                        <hr>
                                                        <form id="contactForm" method="post" action="loginAdministrateur.php"><input class="form-control" type="hidden" name="Introduction" value="This email was sent from www.awebsite.com"><input class="form-control" type="hidden" name="subject" value="Awebsite.com Contact Form">
                                                            <input
                                                                    ...
                                                                    <div class="col">
                                                                        <div class="d-flex flex-column justify-content-center" id="login-box">
                                                                            ...
                                                                            <div class="email-login" style="background-color:#ffffff;">
                                                                                <div class="form-group"><label>Username</label><input class="form-control form-control" type="text" name="usernamead" style="height: 20px;"></div>
                                                                                <div class="form-group"><label>password</label><input class="form-control form-control" type="password" name="mdpad" style="height: 20px;" pattern=".{4,20}"   required title="8 characters minimum jusq'à 20 maximum"></div>
                                                                            </div>
                                                                            <div class="submit-row" style="margin-bottom:8px;padding-top:0px;"><button class="btn btn-primary btn-block box-shadow" id="submit-id-submit" type="submit" name="loginAd">Login</button>
                                                                                <div class="d-flex justify-content-between">
                                                                                    <div class="form-check form-check-inline" id="form-check-rememberMe"><label class="form-check-label" for="formCheck-1"></label></div>
                                                                                    <a
                                                                                        id="forgot-password-link" href="#">Mot de passe oublié?</a>
                                                                                </div>
                                                                            </div>
                                                                            <div id="login-box-footer" style="padding:10px 20px;padding-bottom:23px;padding-top:18px;">
                                                                                <p style="margin-bottom:0px;">Vous n'avez pas de compte?<a id="register-link" href="inscriptionAdministrateur">S'inscrire!</a></p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
