...
<body style="background-color: #f5f5f5;">
            ...
            <div class="col-md-9 content">
                <div class="card" style="border: 0.5px solid #f5f5f5;">
                    <div class="card-header" style="border: 0.5px solid #f5f5f5;">
                        <div class="row">
                            <div class="col-12 col-sm-6 col-lg-7"><button class="btn btn-primary" type="button" style="font-family: 'Karla';font-size: 26px;padding: 0px 7px 0px 7px;top: -7px;font-weight: 800;border-radius: 0px;background-color: #EE161F;border-color: transparent;">Enseignants</button></div>
                            <div
                ...
                <div class="card-body" style="border: 0.5px solid #f5f5f5;box-shadow: inset 0 0 10px;">
                    ...
                    <div class="jumbotron" style="padding: 15px;background-color: #fff;" >
                        <h1 class="text-center" style="font-family:'Aguafina Script', cursive;">Liste des enseignants</h1>
                        <div>
                            <ul style="list-style-type: none;">
                                <li style="font-size: larger;"><a href="https://www.researchgate.net/profile/Rivo_Rakotoarivelo2"><i class="fab fa-researchgate" style="font-size: xx-large;clip-path: circle();margin: 2px 20px 2px 3px;"></i></a>Pr RAKOTOARIVELO Rivonirina Andry &nbsp;(Maladies Infectieuses)
                                    &nbsp; &nbsp;</li>
                                <li style="font-size: larger;"><a href="https://www.researchgate.net/scientific-contributions/2049897678_Tsitohery_Francine_Andriamampionona"><i class="fab fa-researchgate" style="font-size: xx-large;clip-path: circle();margin: 2px 20px 2px 3px;"></i></a>Pr ANDRIAMAMPINONA Tsitohery Francine &nbsp;(Anatomie Pathologie)
								</li>
                                <li style="font-size: larger;"><a href="https://www.researchgate.net/scientific-contributions/33621037_C_L_Andriamady_Rasoarimahandry"><i class="fab fa-researchgate" style="font-size: xx-large;clip-path: circle();margin: 2px 20px 2px 3px;"></i></a>Pr RASOARIMAHANDRY Catherine Lydie &nbsp;(Gynécologie Obstétrique)
                                 </li>
                                <li style="font-size: larger;"><a href="https://www.researchgate.net/profile/Soloniaina_Razafimahefa"><i class="fab fa-researchgate" style="font-size: xx-large;clip-path: circle();margin: 2px 20px 2px 3px;"></i></a>Pr RAZAFIMAHEFA Soloniaina Hélio &nbsp; (Hépato-Gastro-Entérologie)
                                    &nbsp;</li>
                                <li style="font-size: larger;"><a href="https://www.researchgate.net/profile/Zely_Randriamanantany"><i class="fab fa-researchgate" style="font-size: xx-large;clip-path: circle();margin: 2px 20px 2px 3px;"></i></a>Pr RANDRIAMANANTANY Zely Arivelo &nbsp; (Immunologie- Allergologie)</li>
								<li style="font-size: larger;"><a href="https://www.researchgate.net/profile/Arsene_Ratsimbasoa"><i class="fab fa-researchgate" style="font-size: xx-large;clip-path: circle();margin: 2px 20px 2px 3px;"></i></a>Pr RATSIMBASOA Arsène &nbsp; (Santé Publique)</li>
                                <li
                                    style="font-size: larger;"><a href="https://www.researchgate.net/profile/Joelson_Lovaniaina_Rakotoson"><i class="fab fa-researchgate" style="font-size: xx-large;clip-path: circle();margin: 2px 20px 2px 3px;"></i></a>Pr RAKOTOSON&nbsp;Joëlson Lovaniaina &nbsp; (Pneumologie Phtisiologie)</li>
                                        <li
                                            style="font-size: larger;"><a href="https://www.researchgate.net/scientific-contributions/2139021271_Rasamoelina_Ndrantoniaina"><i class="fab fa-researchgate" style="font-size: xx-large;clip-path: circle();margin: 2px 20px 2px 3px;"></i></a>Dr RASAMOELINA Ndratoniaina  &nbsp; (Anesthésie Réanimation)</li>
                                            <li
                                                style="font-size: larger;"><a href="https://www.researchgate.net/scientific-contributions/2030205304_H_Raherimandimby"><i class="fab fa-researchgate" style="font-size: xx-large;clip-path: circle();margin: 2px 20px 2px 3px;"></i></a>Dr RAHERIMANDIMBY Hasina &nbsp; (Biologie Médicale)</li>
                                                <li
                                                    style="font-size: larger;"><a href="https://www.researchgate.net/scientific-contributions/2119879772_R_Fanantenantsoa"><i class="fab fa-researchgate" style="font-size: xx-large;clip-path: circle();margin: 2px 20px 2px 3px;"></i></a>Dr FANANTENANTSOA Rija &nbsp; (Chirurgie Générale)</li>
                                                    <li
                                                        style="font-size: larger;"><a href="https://www.researchgate.net/scientific-contributions/2069429566_Tahiriarivelo_Randriamanantena"><i class="fab fa-researchgate" style="font-size: xx-large;clip-path: circle();margin: 2px 20px 2px 3px;"></i></a>Dr RANDRIAMANANTENA&nbsp;Tahiriarivelo &nbsp; (Chirurgie Maxillo-Faciale)</li>
                                                        <li style="font-size: larger;"><a href="#"><i class="fab fa-researchgate" style="font-size: xx-large;clip-path: circle();margin: 2px 20px 2px 3px;"></i></a>Dr RANDRIAMBOLOLONA Régis Arsène &nbsp; (Chirurgie Traumatologie-Chirurgie) </li>
                                                        <li style="font-size: larger;"><a href="https://www.researchgate.net/scientific-contributions/49308425_R_Razafimahatratra"><i class="fab fa-researchgate" style="font-size: xx-large;clip-path: circle();margin: 2px 20px 2px 3px;"></i></a>Dr RAZAFIMAHATRATRA Rado &nbsp; (Chirurgie Orthopédique et Traumatologie)</li>
                                                        <li style="font-size: larger;"><a href="https://www.researchgate.net/scientific-contributions/2049707657_Hajanirina_Rakotomahenina"><i class="fab fa-researchgate" style="font-size: xx-large;clip-path: circle();margin: 2px 20px 2px 3px;"></i></a>Dr RAKOTOMAHENINA Hajanirina &nbsp; (Gynécologie Obstétrique)</li>
														<li style="font-size: larger;"><a href="https://www.researchgate.net/scientific-contributions/2049726453_P_Ramamonjinirina"><i class="fab fa-researchgate" style="font-size: xx-large;clip-path: circle();margin: 2px 20px 2px 3px;"></i></a>Dr RAMAMONJINIRINA Tahiana Prudence  &nbsp; (Pédiatrie)</li>	
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    </div><?php require("responsable.php"); ?>
