...
<body>
	<input id="codeAdminAncien" class="d-none" value='<?php if(isset($_SESSION['codead'])){$_SESSION['codead'];} ?>' >
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
						<br>
						<br>
						 <div id="div"><i class="fa fa-user" id="iconUser"></i><span>Usename  &nbsp; &nbsp; &nbsp; &nbsp;  :</span><input type="text" class="input" name="usernameAdmin" value='<?php  if(isset($_SESSION['usernamead'])){echo $_SESSION['usernamead']; } ?>' ></div>
                        <div id="div"><i class="fa fa-user" id="iconUser"></i><span>CodeAdmin &nbsp; &nbsp; :</span><input type="text" name="codeAdmin" class="input" value='<?php  if(isset($_SESSION['codead'])){echo $_SESSION['codead'];} ?>' ></div>
