...
?>
    ...
    <div>
	<form action="afficherEt.php" method="POST" enctype="multipart/form-data">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8" style="background-color: #ccc;">
                    <div class="container">
						<input type="hidden" name="pseudo" value="<?php echo $_SESSION["usernameet"]; ?>" >
                        ...
                        <div class="form-group"><textarea id="summernote" name="editordata" style="width: 43vw;"></textarea></div>
	...
	<?php if(isset($msg)){?>
			swal({
				 ...
				 icon:'success',
					...
					if (willDelete) {
						document.location.href="afficherEt.php";
					}else{
						document.location.href="afficherEt.php";	
					}
				});
