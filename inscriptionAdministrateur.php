                                            ...
                                            <div class="col">
                                                <div>
													...
													<a href="index" style="font-size: 25px;"><i class="fa fa-home"></i></a>
                                                        <hr>
                                                        <form id="contactForm" method="post" action="inscriptionAdministrateur.php">
                                                                    ...
                                                                    <div class="col">
                                                                        <div class="d-flex flex-column justify-content-center" id="login-box">
                                                                            <div class="login-box-header">
                                                                                <h4 style="color:rgb(139,139,139);margin-bottom:0px;font-weight:400;font-size:27px;">Register Admin</h4>
                                                                            </div>
                                                                            ...
                                                                            <div class="email-login" style="background-color:#ffffff;">
                                                                                <div class="form-group"><label>Code</label><input class="form-control form-control" type="text" name="codead" style="height: 20px;"></div>                                                                             
                                                                            ...
                                                                            <div class="submit-row" style="margin-bottom:8px;padding-top:0px;"><button class="btn btn-primary btn-block box-shadow" id="submit-id-submit" type="submit" name="registerAd">Register</button>
                                                                                
                                                                            </div>
                                                                            <div id="login-box-footer" style="padding:10px 20px;padding-bottom:23px;padding-top:18px;">
                                                                                <p style="margin-bottom:0px;">Vous avez déjà un compte?<a id="register-link" href="loginAdministrateur">Se connecter!</a></p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
