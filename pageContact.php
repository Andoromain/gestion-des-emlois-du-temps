            ...
            <div class="col-md-9 content">
                <div class="card" style="border: 0.5px solid #f5f5f5;">
                    <div class="card-header" style="border: 0.5px solid #f5f5f5;">
                        <div class="row">
                            <div class="col-12 col-sm-6 col-lg-7"><button class="btn btn-primary" type="button" style="font-family: 'Karla';font-size: 26px;padding: 0px 7px 0px 7px;top: -7px;font-weight: 800;border-radius: 0px;background-color: #EE161F;border-color: transparent;">Contacts</button></div>
                            <div
                ...
                <div class="card-body" style="border: 0.5px solid #f5f5f5;box-shadow: inset 0 0 10px;">
                    ...
                    <div class="jumbotron" style="padding: 15px;background-color: #fff;" >
                        <h1 class="text-center" style="font-family:'Aguafina Script', cursive;">Contacts </h1><span><br><br></span>
                        <ul>
                            <li>E-mail : &nbsp;<a href="#" style="text-decoration:underline">facmed.fianarantsoa@facmedfianar.mg</a><br></li>
                            <li>Tél : &nbsp; +261 34 99 244 64&nbsp;<br></li>
                            <li>Site web : &nbsp; <a style="text-decoration:underline" href="https://facmedfianar.mg"> https://facmedfianar.mg </a><br></li>
                            <li>Facebook : &nbsp; <a style="text-decoration:underline" href="https://www.facebook.com/groups/302437857152045/?_rdc=1&_rdr">https://www.facebook.com/groups/302437857152045/?_rdc=1&_rdr </a><br></li>
                        </ul>
