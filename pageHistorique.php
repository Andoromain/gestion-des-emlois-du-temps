            ...
            <div class="col-md-9 content">
                <div class="card" style="border: 0.5px solid #f5f5f5;">
                    <div class="card-header" style="border: 0.5px solid #f5f5f5;">
                        <div class="row">
                            <div class="col-12 col-sm-6 col-lg-7"><button class="btn btn-primary" type="button" style="font-family: 'Karla';font-size: 26px;padding: 0px 7px 0px 7px;top: -7px;font-weight: 800;border-radius: 0px;background-color: #EE161F;border-color: transparent;">Historique</button></div>
                            <div
                ...
                <div class="card-body" style="border: 0.5px solid #f5f5f5;box-shadow: inset 0 0 10px;">
                    ...
                    <div class="jumbotron" style="padding: 15px;background-color: #fff;">
                        <h1 class="text-center" style="font-family:'Aguafina Script', cursive;">Historique de la Faculté de Médecine Fianarantsoa</h1>
                        <p> </p>
                        <div id="cbp-fwslider" class="cbp-fwslider"></div>
                    </div>
                </div>
            </div>
        </div>
