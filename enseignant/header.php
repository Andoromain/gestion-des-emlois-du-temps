...
<body>
    ...
    <nav class="navbar navbar-light navbar-expand-md" id="navMenu" style="">
        <div class="container-fluid"><a class="navbar-brand" href="../enseignant/acceuil.php" style="color:rgb(102,153,255)">Home</a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse"
                id="navcol-1">
                <ul class="nav navbar-nav" id="navigation">
                    <li class="nav-item" role="presentation" id="adminNav"><a class="nav-link " href="../enseignant/pageET.php">Emploi du Temps</a></li>
					<li class="nav-item " style="background-color:rgb(102,153,255)"><a class=" nav-link " data-toggle="dropdown-item" aria-expanded="false" href="../blog/afficherEn.php">Blog</a>
                        </li>
