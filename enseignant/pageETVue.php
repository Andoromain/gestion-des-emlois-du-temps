...
<body>
	 ...
	 <input id="emailen" class="d-none" value='<?php echo $_SESSION["emailen"]; ?>' >
        ...
        <div class="container-fluid"><a class="navbar-brand" href="acceuil.php">Home</a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav" id="navigation">
                    <li class="nav-item" role="presentation" id="adminNav" style="background-color:rgb(102,153,255)"><a class="nav-link active" href="pageET.php" >Emploi du Temps</a></li>
					<li class="nav-item" role="presentation" id="adminNav"><a class="nav-link " href="../blog/afficherEn.php">Blog</a></li>
    ...
    <div class="container" id="ETen">
       ...
       <select id="L1manokana" >
		...
		<div id="hafa" class="d-none">
		     <select id="parcoursSearch"><option value="MED" selected="">Medecine </option><option value="SGF">Sage Femme</option><option value="TCL">Technicien de Labo</option><option value="INF">Infirmerie</option></select><select id="niveauSearch"><option value="L2">L2</option><option value="L3">L3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option></select>
         <br><br>
    </div>
            <button
                class="btn btn-primary" type="button" id="search" style="padding: 2px 6px 6px 6px;"><i class="icon ion-ios-search"></i>
			</button>
        </div>
        <h4 class="text-center headingETen">Liste des evenements des enseignants dans&nbsp;<span id="niveauSpan">.....</span><span id="parcoursSpan">........</span>&nbsp;&nbsp;</h4><br>


		<div id="calendarEn"></div><br>

		<h4 class="text-center headingETen"><span style="text-decoration: underline;">Mon Evenement</span></h4>
		<button class="btn btn-primary" data-toggle="modal" data-target="#modalAddEvent" type="button" style="margin-left:18%;"><i class="fa fa-plus"></i>&nbsp;Ajouter</button>
		<br>
		<br>
		...
		<div id="calendar"></div>
		<br><br>
		<button class="btn btn-primary" type="button"  style="margin-left:550px" id="genererPDFEn">Generer du PDF</button>


        <div class="modal fade" role="dialog" tabindex="-1" id="modalAddEvent">
			<form>
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p class="text">Evenement:</p><input type="text" id="nomEvenement" class="input">
					...
					<div id="autre" class="d-none">
						<p><span class="" >Parcours :</span><span id="textNiveau" class="">Niveau :</span></p><select id="parcours" class="input"><option value="MED" selected="">Medecine Humaine</option><option value="SGF">Sage Femme</option><option value="TCL">Technicien de Labo</option><option value="INF">Infirmerie</option></select>
                        <select
                            id="niveau" class="input">
							...
							<p class="text">Matiere :</p><input type="text" id="matiere" class="input" list="dataMatiere" onkeyup="javascript:envoyerReqMatiere('ajaxMatiere.php',this.value)">
                            ...
                            <p class="text">Lieu :</p><input type="text" id="lieu" class="input">
                            <p class="text">Repetition :</p><input type="radio" id="uneseulefois" name="repetition" value="1"><label>une seule fois</label>
                            <p><input type="radio" id="repeatSemaine" name="repetition" value="7"><label>par semaine</label></p>
                            <div class="d-none" id="repetition"><label id="label">Debut &nbsp; :&nbsp;</label><input type="date" id="dateDeb">
                                <div><label>Fin &nbsp; &nbsp; &nbsp; &nbsp;:&nbsp;</label><input type="date" id="dateFin"></div>
                            </div>
                            <p class="text">Quand :</p>
							<!--niova ny heure -->
								
							 <div><label>Date &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: &nbsp;</label><input class="form-control-sm" type="date" id="date"></div><label>heure debut &nbsp;: &nbsp;</label><input class="form-control-sm" type="time" id="heureDeb">
                            <div><label>heure fin &nbsp; &nbsp; &nbsp; &nbsp;: &nbsp;</label><input class="form-control-sm" type="time" id="heureFin"></div>
							
							
							<!--niova ny heure -->
                            <div id="cancelSave"><button class="btn btn-primary" type="button" id="enregistrer">Enregistrer</button></div>
                    </div>
                ...
                <div class="modal-content">
					...
					<div id="autreU" class="d-none">
                        ...
                        <select
                            ...
                            <p class="text">Matiere :</p><input type="text" id="matiere" list="dataMatiere" class="input" onkeyup="javascript:envoyerReqMatiere('ajaxMatiere.php',this.value)" >
                            <datalist id="dataMatiere">
          								        <option></option>
          								        <option></option>
          								        <option></option>
                            ...
                            <p class="text">Quand :</p>
                            <div><label>Date &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: &nbsp;</label><input class="form-control-sm" type="date" id="date"></div><label>heure debut &nbsp;: &nbsp;</label><input class="form-control-sm" type="time" id="heureDeb">
                            <div><label>heure fin &nbsp; &nbsp; &nbsp; &nbsp;: &nbsp;</label><input class="form-control-sm" type="time" id="heureFin"></div><button class="btn btn-primary" type="button" id="supprimer">Supprimer</button><button class="btn btn-primary"
                                type="button" id="modifier">Modifier</button></div>
                    <div class="modal-footer">
                        <h5 id="titreFac">Faculte de Medecine</h5><img src="../assets/img/Logo_Méds%20Fianar%20-%20vf2.jpg" id="logoFac"></div>
                </div>
            </div>
    ...
    <script src="../assets/js/functionCalendar.js"></script>
	...
	var fin="    "+jour+" "+mois+"   "+annee;
			...
			html2canvas($('#calendar .fc-view-container'), {
